...
function Footer() {
  return (
    <div style={{width:'100%',height:'350px'}} className='d-flex flex-column justify-content-center align-items-center text-light bg-success'>
    <div className="footer-div d-flex justify-content-evenly flex-wrap w-100">
      <div className="website" style={{width:'400px'}}>
        <h4><i class="fa-brands fa-shirtsinbulk"></i>T-rex</h4>
    ...
    <p>Copyright @ 2023 T-rex. Build with React</p>
  </div>
  )
}
